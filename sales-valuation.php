<?php
/**
 * Sales Valuation Form for Love View Estate
 */

// Page specific variables
$pageTitle = 'Sales Valuation';
  ...
  <div class="valuation-container">
    <div class="valuation-form-wrapper">
      <div class="valuation-form-left">
        ...
        <form class="valuation-form" action="/submit-valuation.php" method="post">
      ...
      <div class="valuation-form-right">
        ...
        <ul class="next-steps">
          ...
          <li>
            <i class="fas fa-check-circle"></i>
            <span>Find out how to maximise your property's sales or rental potential</span>
          </li>
        </ul>
      </div>
    </div>
