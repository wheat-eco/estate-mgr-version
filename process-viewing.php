<?php
/**
 * Process viewing request for Love View Estate
 */
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO viewing_requests (property_id, name, email, phone, preferred_date, message, status) VALUES (?, ?, ?, ?, ?, ?, 'pending')");
    ...
    if ($stmt->execute()) {
        ...
        $subject = "New Viewing Request: " . $_POST['property_title'];
        $emailMessage = "A new viewing request has been submitted:\n\n";
        $emailMessage .= "Property: " . $_POST['property_title'] . "\n";
