...
$pageTitle = 'North Ayrshire Properties For Sale';
    ...
    <div class="properties-list">
      ...
      <?php else: ?>
        <div class="no-properties">
          <p>No properties currently for sale in North Ayrshire. Please check back soon or contact us for more information.</p>
        </div>
      <?php endif; ?>
    </div>
  </div>
